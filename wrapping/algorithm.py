...
def double_cylinder_obstacle_set_algorithm(P, S, Cylinder_U, Cylinder_V, rotation_matrix_UV, G0_q0 = [0,0,0]) :
   ...
   # G0_q0_V = transpose_switch_frame(G0_q0, Cylinder_v.matrix)
   # ------
   # Step 2
   # ------
