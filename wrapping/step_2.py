...
def find_tangent_points_iterative_method(P_U_cylinder_frame, S_V_cylinder_frame, r_V, r_U, rotation_matrix_UV, G0_q0_V = [0,0,0]) :
  ...
  g0 = transpose_switch_frame(G0, rotation_matrix_UV) # ok à priori ...
  # print("g0 = ", g0)
